...
##########################################################################################################################33
if args.trainer == 'ewc' or args.trainer == 'rwalk' or args.trainer == 'mas' or args.trainer == 'si':
...
if args.output == '':
    args.output = 'AGS-CL/result_data/' + log_name + '.txt'
########################################################################################################################
# Seed
...
for t, ncla in taskcla:
    ...
    torch.save(myModel.state_dict(), 'AGS-CL/trained_model/' + log_name + '_task_{}.pt'.format(t))
